...
export default function Username() {
  ...
  return ( 
    <div className={styles.container} style={{ backgroundImage: `url('https://wallpaperbat.com/img/645556-free-download-hospital-wallpaper-in-collection-page-1-4400x2452-for-your-desktop-mobile-tablet-explore-hospital-wallpaper-hospital-wallpaper.jpg')` }}> {/* Set background image here */}
